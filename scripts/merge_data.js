 ...
 * Version: 2.25.2 (Hotfix: Config Path & Inclusive BR Rule)
 */
...
const DATA_DIR = "data";
const CONFIG_PATH = path.join("config", "lists.json"); // Caminho Corrigido
...
async function run() {
    try {
        console.log("🔄 Executando Fusão de Dados v2.25.2...");
        ...
        // 1. Atualizar Histórico Individual
        ...
        // 2. Regra de Brasileiros Ativos (Inclusiva)
        // Regra: Está em qualquer lista BR E postou nos últimos 30 dias.
